...
local EAT_INVERVALL = GetModConfigData("DOYDOYPET_EAT_INVERVALL") - 1
...
TUNING.DOYDOYPET_TO_TEEN = EAT_INVERVALL
TUNING.DOYDOYPET_TO_ADULT = EAT_INVERVALL * 1.5

TUNING.DOYDOYPET_DIE_OLD_AGE = (EAT_INVERVALL * GetModConfigData("DOYDOYPET_DIE_OLD_AGE")) + TUNING.DOYDOYPET_TO_ADULT
TUNING.DOYDOYPET_EAT_INVERVALL = (total_day_time / EAT_INVERVALL - 32)
