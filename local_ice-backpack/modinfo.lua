...
configuration_options = {{
    ...
    options = {{
        ...
        description = "Science Machine",
        data = 1
    }, {
        description = "Alchemy Engine",
        data = 2
    }, {
        description = "Prestihatitator",
        data = 3
    }, {
        description = "Shadow Manipulator",
        data = 4
    }, {
        description = "Ancient Pseudoscience Station",
        data = 5
    }},
    default = 1
}, {
